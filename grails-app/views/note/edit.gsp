                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="text"><g:message code="note.text.label" default="Text" /></label>
                                </td>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="ticket"><g:message code="note.ticket.label" default="Ticket" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: noteInstance, field: 'ticket', 'errors')}">
                                    <g:select name="ticket.id" from="${org.humphries.Ticket.list()}" optionKey="id" value="${noteInstance?.ticket?.id}"  />
                                </td>
                            </tr>
