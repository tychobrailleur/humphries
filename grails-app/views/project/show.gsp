            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="project.tags.label" default="Tags" /></td>
                            
                            <td valign="top" style="text-align: left;" class="value">
                                <ul>
                                <g:each in="${projectInstance.tags}" var="t">
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="project.tickets.label" default="Tickets" /></td>
